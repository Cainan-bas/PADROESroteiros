...
// Pergunta 5: O impacto criado pela implementação do SAP, sera apenas o acrescimo de um IF nas classes controladoras

// Pergunta 7: Mesmo sendo simples a implementação do SAP no sistema, o fato de a toda novo sistemar ser necessario a alteração de todas as classes controladoras, mostra que
// o sistema não é escalavel.